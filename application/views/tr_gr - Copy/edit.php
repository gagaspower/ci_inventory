                            ...
                            <div class="row" >
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-xs-12 col-sm-4 btn-lg text-center">
                                        <input type="hidden" id="gr_total_harga_beli_val" name="gr_total_harga_beli_val" value="0">
...
function modal_add_gr_d(index_data){
    ...
    $('#tr_gr_d').bootstrapTable(state, {
        ...
        row : {
            ...
            gr_total_harga_beli : $("#modal_item_harga_beli").val() * qty,
...
$("#gr_save").click( function (){
    ...
    var gr_total_harga_beli =  $("#gr_total_harga_beli_val").val();
    var gr_total_harga_jual = $("#gr_total_harga_jual").val();
    ...
    $.ajax({
        ...
        success: function( data ){
            swal({
                ...
                html:  'Nomor PO anda : ' + data.kode_gr,
...
function recount_data( arrayTable ){
    ...
    for ( i=0; i<=arrayTable.length-1; i++ ){
        ...
        total_harga_jual += ( temp_table.gr_item_qty * temp_table.gr_harga_jual_item );
    }
    ...
    $("#gr_total_harga_beli_val").val(total_harga_beli);
}
