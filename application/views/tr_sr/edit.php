                             ...
                             <div class="box-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label >Kode SR</label>
                                            <input type="text" class="form-control"  name="kode_sr" id="kode_sr"  readonly>
                                        </div> 
                                    </div>
                                </div>
                                <div class="form-group">
...
$.ajax({
    ...
    $("#search_so").click( function (){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>sr/get-so-edit",
            data: {
...
function load_data_sr(){
            $.ajax({
                type: "GET",
                url:"<?php echo base_url();?>sr/show/" + gr_id_edit,
                dataType : "json",
                success: function( data ){
                    console.log (data);
                    window.sr_data = Get_Header_Detail ( data, "id", sr_header, sr_detail );
                    $('#tr_sr_d').bootstrapTable('load', sr_data[0].pod);
                    // console.log(cegr_data[0].total_harga_beli_gr);
                    // $('#suplier_gr').val(gr_data[0].suplier_gr).trigger('change');
                    $('#tgl_sr').val(sr_data[0].tgl_sr);
                    $('#keterangan_sr').val(sr_data[0].keterangan_sr);
                    $('#kode_sr').val(sr_data[0].kode_sr);
                    $('#id').val(sr_data[0].id);
                    
                    $('#tr_sr_d').bootstrapTable('checkAll');
                    recount_data( $('#tr_sr_d').bootstrapTable('getData') );
                },
                error: function( data ){
                    console.log( data );
