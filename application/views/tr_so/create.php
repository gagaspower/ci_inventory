                             ...
                             <div class="box-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label >Kode SO</label>
                                            <input type="text" class="form-control"  name="kode_so" id="kode_so" value="<?php echo $kode_so;?>" readonly>
                                        </div> 
                                    </div>
                                </div>
                                <div class="form-group">
...
$('#modal_item_code').change(function(){ 
    ...
    console.log(item_id);
    $.ajax({
        url : "<?php echo base_url();?>cek_stok",
        method : "POST",
...
function modal_add_so_d(index_data){
    ...
    var stok = parseInt( $("#modal_stok").val() );
...
$("#so_save").click( function (){
    ...
    $.ajax({
        method: "POST",
        url:"<?php echo base_url();?>so/simpan",
        async : true,
        dataType : 'json',
        data: {
