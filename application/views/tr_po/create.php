                             ...
                             <div class="box-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label >Kode PO</label>
                                            <input type="text" class="form-control"  name="kode_po" id="kode_po" value="<?php echo $kode_po;?>" readonly>
                                        </div> 
                                    </div>
                                </div>
                                <div class="form-group">
...
function modal_add_po_d(index_data){
    ...
    $('#tr_po_d').bootstrapTable(state, {
        ...
        row : {
            ...
            po_total_harga_beli : parseInt($("#modal_item_harga_beli").val()) * qty,
...
$("#po_save").click( function (){
    ...
    var po_total_harga_beli = parseInt( numeral($("#po_total_harga_beli").text()).format('0.000') );
    var po_total_harga_jual = parseInt( numeral($("#po_total_harga_jual").val()).format('0.000') );
    ...
    $.ajax({
        method: "POST",
        url:"<?php echo base_url();?>po/simpan",
        async : true,
        dataType : 'json',
        data: {
...
function recount_data( arrayTable ){
    ...
    for ( i=0; i<=arrayTable.length-1; i++ ){
        ...
        total_harga_beli += temp_table.po_total_harga_beli;
        total_harga_jual +=  ( temp_table.po_item_qty * numeral(temp_table.po_harga_jual_item).format('0.000') );
    }
