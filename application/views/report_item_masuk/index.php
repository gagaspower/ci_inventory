                    ...
                    <div class="box">
                        ...
                        <table id="table"
                                ...
                                <tr>
                                        ...
                                        <th data-field="tgl_gr">Tgl TRX</th>
                                        <th data-field="kode_gr">Kode TRX</th>
                                        <th data-field="keterangan_gr">Detail TRX</th>
                                        <th data-field="total_harga_beli_gr" data-formatter="moneyFormatter">Nilai</th>
                                    </tr>
                                </thead>
    ...
    $(function () {
        ...
        function searchItem() {
            var date_range = $("#range_id").val();
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>get-stok-masuk",
                    data: {
                    ...
                    success: function (data) {
                        ...
                        var totalNilai = data.reduce(function(a, b){
                            return a + parseFloat(b.total_harga_beli_gr);
                        }, 0);
