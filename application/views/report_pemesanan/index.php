                    ...
                    <div class="box">
                        ...
                        <table id="table"
                                ...
                                <tr>
                                        ...
                                        <th data-field="tgl_po">Tgl TRX</th>
                                        <th data-field="kode_po">Kode TRX</th>
                                        <th data-field="keterangan_po">Detail TRX</th>
                                        <th data-field="nama_suplier">Suplier</th>
                                        <th data-field="total_harga_beli_po" data-formatter="moneyFormatter">Nilai</th>
                                    </tr>
                                </thead>
    ...
    $(function () {
        ...
        function searchItem() {
            var date_range = $("#range_id").val();
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>get-report-pemesanan",
                    data: {
                    ...
                    success: function (data) {
                        ...
                        var totalNilai = data.reduce(function(a, b){
                            return a + parseFloat(b.total_harga_beli_po);
                        }, 0);
