            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <form role="form" method="post" action="<?php echo base_url('item/update');?>">
                            <input type="hidden" name="id" value="<?php echo $id;?>">
                             <div class="box-body">
                             <div class="form-group">
                                    <label for="exampleInputEmail1">Kode Barang</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="kode_barang" value="<?php echo $kode_barang;?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Item</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="nama_item" autocomplete="off" value="<?php echo $nama_barang;?>">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Harga Beli</label>
                                    <input type="number" min="0" class="form-control" id="exampleInputEmail1"  name="harga_beli" autocomplete="off" value="<?php echo $harga_beli;?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Harga Jual</label>
                                    <input type="number" min="0" class="form-control" id="exampleInputPassword1"  name="harga_jual" autocomplete="off" value="<?php echo $harga_jual;?>">
                                </div>
                            </div>
