                    ...
                    <div class="box">
                        ...
                        <table id="table"
                                ...
                                <tr>
                                        ...
                                        <th data-field="tgl_so">Tgl TRX</th>
                                        <th data-field="kode_so">Kode TRX</th>
                                        <th data-field="keterangan_so">Detail TRX</th>
                                        <th data-field="nama_customer">Customer</th>
                                        <th data-field="so_total_harga_jual" data-formatter="moneyFormatter">Nilai</th>
                                    </tr>
                                </thead>
                                <tfoot class="box-total">
                                    <tr>
                                    <td></td>
                                    <td></td>
                                    <td></td>
    ...
    $(function () {
        ...
        function searchItem() {
            var date_range = $("#range_id").val();
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>get-report-penjualan",
                    data: {
                    ...
                    success: function (data) {
                        ...
                        var totalNilai = data.reduce(function(a, b){
                            return a + parseFloat(b.so_total_harga_jual);
                        }, 0);
