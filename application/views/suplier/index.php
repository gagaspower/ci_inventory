        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="col-md-12">
                            <div class="pull-left"> <button type="button " class="btn btn-info btn-flat btn-sm" onclick="window.location.href='<?php echo base_url('suplier/tambah');?>'">
                            ...
                            <table id="example2" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['tlp_suplier'];?></td>
                                        <td>
                                        <button type="button " class="btn btn-info btn-flat btn-sm" onclick="window.location.href='<?php echo base_url();?>suplier/edit/<?php echo $row['id'];?>'">
                                        <i class="fa fa-edit"></i> Edit</button>
                                        <button type="button " class="btn btn-warning btn-flat btn-sm" onclick="window.location.href='<?php echo base_url();?>suplier/delete/<?php echo $row['id'];?>'">
