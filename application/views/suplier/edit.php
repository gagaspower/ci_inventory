            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <form role="form" method="post" action="<?php echo base_url('suplier/update');?>">
                            <input type="hidden" name="id" value="<?php echo $id;?>">
                             <div class="box-body">
                             <div class="form-group">
                                    <label for="exampleInputEmail1">Kode Suplier</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="kode_suplier" value="<?php echo $kode_suplier;?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nama Suplier</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="nama_suplier" autocomplete="off" value="<?php echo $nama_suplier;?>">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Alamat Suplier</label>
                                    <textarea class="form-control" id="exampleInputEmail1"  name="alamat_suplier" ><?php echo $alamat_suplier;?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Tlp Suplier</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1"  name="tlp_suplier" autocomplete="off" value="<?php echo $tlp_suplier;?>">
                                </div>
                            </div>
