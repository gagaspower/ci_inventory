            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <form role="form" method="post" action="<?php echo base_url('suplier/simpan');?>">
                             <div class="box-body">
                             <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="nama_suplier" autocomplete="off" required>
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Alamat Suplier</label>
                                    <textarea class="form-control" id="exampleInputEmail1"  name="alamat_suplier" ></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Tlp Suplier</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1"  name="tlp_suplier" autocomplete="off">
                                </div>
                            </div>
